...
public class RedisCache {
    ...
    public void incrementMapValue(String key, String hashKey) {
        redisTemplate.opsForHash().increment(key, hashKey, 1);
    }

    public void  decreseMapValue(String key,String hashKey){
        redisTemplate.opsForHash().increment(key,hashKey,-1);
    }

    public void incrementMapValue(String key, String hashKey,Integer value) {
